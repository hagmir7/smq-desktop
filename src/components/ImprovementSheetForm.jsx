...
export default function ImprovementSheetForm({ id, onSaved }) {
  ...
  const handleFinish = async (values) => {
    ...
    try {
      ...
      const { data } = await api.post(`/improvement-sheets/${id}`, payload);
  ...
  return (
    <Card title="Modifier la fiche d'amélioration" style={{ maxWidth: 900, margin: "0 auto" }}>
      <Form form={form} layout="vertical" onFinish={handleFinish}>
        ...
        <Row gutter={16}>
          ...
          <Col span={8}>
            <Form.Item name="effectiveness" label="Efficacité">
              <Select placeholder="Sélectionner l'efficacité" allowClear>
